  ...
  return (
    <section className="px-8 py-16">
      <div className="container mx-auto mb-20 text-center">
        <h1 className="text-4xl font-bold text-gray-800 mb-4">Contact KEVIN !</h1>
      ...
      <div className="container mx-auto border border-gray-300 p-8 rounded-lg shadow-lg">
        ...
        <p className="text-gray-500 mb-8">Fill up the form and Kevin will get back to you within 24 hours.</p>
